...
describe("addcourse with schemes and one of the payment mode and without scholarship",function(){
    this.retries(3)

    it("course with schemes and one of the payment mode and without scholarship",async() =>{
    await browser.url("https://dev-alis.viasimplex.in/");
        ...
        await Coursepage.enterCoursename(signinData.course4);
        await browser.pause(5000);
        await Coursepage.enterShortCode(signinData.courseshortcode4);
        await browser.pause(5000);
