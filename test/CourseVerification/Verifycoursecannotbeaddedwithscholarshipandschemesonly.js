...
describe("addcourse without payment mode",function(){
    this.retries(3)

    it("course without payment mode",async() =>{
    await browser.url("https://dev-alis.viasimplex.in/");
        ...
        await Coursepage.enterCoursename(signinData.course6);
        await browser.pause(5000);
        await Coursepage.enterShortCode(signinData.courseshortcode6);
        await browser.pause(5000);
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifycoursecannotbeaddedwithscholarshipandschemesonly.png")
    })
})
