...
describe("Verification of payments save button is clickable or not",function(){
    this.retries(3)

    it("course payment save button ",async() =>{
    await browser.url("https://dev-alis.viasimplex.in/");
        ...
        await Coursepage.coursePaymentsaveisclickable();
        await browser.pause(5000);
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifycoursepaymentsavebuttonclickable.png")
    })
})
