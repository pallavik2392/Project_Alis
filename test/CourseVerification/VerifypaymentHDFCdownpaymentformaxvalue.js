...
describe("Verification of hdfc's downpayment field for   max validation ",function(){
    this.retries(3)

    it("course  hdfc's downpaymentt  field for max validation",async() =>{
    await browser.url("https://dev-alis.viasimplex.in/");
        ...
        await Coursepage.selectHdfcfinancemode(signinData.HDFCdiscountType,signinData.HDFCDiscountamount,signinData.coursepaymenthdfcdownpaymentformaxvalue,signinData.HDFCmaxInstallment,signinData.HDFCDocuments);
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifypaymenthdfcdownpaymentformaxvalue.png")
    })
})
