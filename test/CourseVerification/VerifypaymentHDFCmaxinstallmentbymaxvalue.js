...
describe("Verification of hdfc's maxinstallments field max validation ",function(){
    this.retries(3)

    it("course  hdfc's maxinstallments field max validation ",async() =>{
    await browser.url("https://dev-alis.viasimplex.in/");
        ...
        await Coursepage.selectHdfcfinancemode(signinData.HDFCdiscountType,signinData.HDFCDiscountamount,signinData.HDFCDownpayment,signinData.coursepaymentHDFCmaxinstallmentwithmaxvalue,signinData.HDFCDocuments);
