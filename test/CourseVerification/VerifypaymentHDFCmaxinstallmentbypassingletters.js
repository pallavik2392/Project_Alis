...
describe("Verification of hdfc's maxinstallments field for letters ",function(){
    this.retries(3)

    it("course  hdfc's maxinstallments field for letters ",async() =>{
    await browser.url("https://dev-alis.viasimplex.in/");
        ...
        await Coursepage.selectHdfcfinancemode(signinData.HDFCdiscountType,signinData.HDFCDiscountamount,signinData.HDFCDownpayment,signinData.coursepaymentHDFCmaxinstallmentwithletters,signinData.HDFCDocuments);
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/VerifypaymentHDFCmaxinstallmentbypassingletters.png")
    })
})
