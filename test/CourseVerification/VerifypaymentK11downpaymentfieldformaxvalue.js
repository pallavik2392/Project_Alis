...
describe("Verification of K11 downpayment field for maximum validation ",function(){
    this.retries(3)

    it("course  K11 downpayment field for maximum validation ",async() =>{
    await browser.url("https://dev-alis.viasimplex.in/");
        ...
        await Coursepage.selectK11mode(signinData.K11discountType,signinData.K11Discountamount,signinData.coursepaymentK11downpaymentformaxvalue,signinData.K11maxInstallment,signinData.K11Documents);
        await browser.pause(5000);
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/VerifypaymentK11downpaymentfieldformaxvalue.png")
    })
})
