...
describe("Verification of K11 max installments field by passing letters ",function(){
    this.retries(3)

    it("course  K11 max installments field by passing letters ",async() =>{
    await browser.url("https://dev-alis.viasimplex.in/");
        ...
        await Coursepage.selectK11mode(signinData.K11discountType,signinData.K11Discountamount,signinData.K11Downpayment,signinData.coursepaymentK11maxintallmentswithletters,signinData.K11Documents);
        await browser.pause(5000);
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/VerifypaymentK11maxinstallmentbyletters.png")
    })
})
