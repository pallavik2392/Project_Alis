...
describe("Verification of bajaj finance's downpayment  field is masked or not ",function(){
    this.retries(3)

    it("course  downpayment  field for masked",async() =>{
    await browser.url("https://dev-alis.viasimplex.in/");
        ...
        await Coursepage.selectBajajfinancemode(signinData.BajajdiscountType,signinData.BajajDiscountamount,signinData.coursepaymentbajajdownpaymentformaskeddata,signinData.BajajmaxInstallment,signinData.BajajDocuments);
