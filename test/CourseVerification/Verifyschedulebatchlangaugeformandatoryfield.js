...
describe("Verify schedule tab   batch langauge field for mandatory field  ",function(){
    this.retries(3)

    it("batch langauge for mandatory ",async() =>{
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifyschedulebatchlangaugeformandatoryfield.png")
    })
})