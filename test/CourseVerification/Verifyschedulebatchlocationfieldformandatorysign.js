...
describe("Verify schedule tab   batch location field for mandatory field  ",function(){
    this.retries(3)

    it("batchlocation for mandatory ",async() =>{
    await browser.url("https://dev-alis.viasimplex.in/");
        ...
        const message=await $("//p[@id='location-helper-text']");
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifyschedulebatchlocationfieldformandatorysign.png")
    })
})