...
describe("verify for executive role should  able to select particulr course",function(){
    this.retries(3)

    it("verify particular course selecable",async()=> {
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/VerifyExecutiveabletoselectparticularcourse.png")
    })
})