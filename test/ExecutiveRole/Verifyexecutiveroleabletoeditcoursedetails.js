...
describe("verify for executive role should  able to update course",function(){
    this.retries(3)

    it("verify particular course able to update",async()=> {
...
*/
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifyexecutiveroleabletoeditcoursedetails.png")
    })
})