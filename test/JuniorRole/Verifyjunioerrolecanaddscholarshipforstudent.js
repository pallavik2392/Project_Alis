...
describe("verify for junior role can add scholorship",function(){
    this.retries(3)

    it("verify junior can add scholarship",async()=> {
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifyjunioraddscholarshiptostudent.png")
    })
})