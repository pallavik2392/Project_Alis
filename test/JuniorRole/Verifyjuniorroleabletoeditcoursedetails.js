...
describe("verify for junior role should  able to update course",function(){
    this.retries(3)

    it("verify particular course able to update junior",async()=> {
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifyjuniorroleabletoeditcoursedetails.png")
    })
})