...
describe("verify Staff last name field by passing valid name",function(){
    this.retries(3)

    it("Staff last name field with valid name", async() =>{
        ...
        await browser.pause(5000);
        await Staffpage.enterLastname(signinData.stafflastnamewithvalidname);
        await browser.pause(3000);
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifystafflastnamewithvalidname.png")
    })
})