...
describe("verify Staff  phonenumber field by passing >10 digit",function(){
    ...
    it("Staff phonenumber field with >10 digit", async() =>{
        ...
        await browser.pause(5000);
        await Staffpage.enterPhonenumber(signinData.staffphonewithgreaterthan10);
        await browser.pause(3000);
        ...
        //await browser.saveScreenshot("./ScreenshotsforAlis/staff18.png");

    })
    // screenshot issue resolved by using link ==>> https://youtu.be/ouyvnPo9IjQ
   
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifystaffphonewith>10digit.png")
    })
})