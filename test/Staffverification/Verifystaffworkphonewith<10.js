...
describe("verify Staff work phonenumber field by passing <10 numbers",function(){
    ...
    it("Staff work phonenumber field with <10 numbers", async() =>{
        ...
        await browser.pause(5000);
        await Staffpage.enterworkPhonenumber(signinData.staffworkphonewithlessthan10);
        await browser.pause(3000);
       ...
       // await browser.saveScreenshot("./ScreenshotsforAlis/staff24.png");

    })
    // screenshot issue resolved by using link ==>> https://youtu.be/ouyvnPo9IjQ
   
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifystaffworkphonewith<10.png")
    })
})