...
describe("Verify courses cancel admission button is clickable ",function(){
    this.retries(2)

    it("cancel admission  button is clickable",async()=> {
        ...
        await Studentpage.coursescanceladmissionisclickable();
        await browser.pause(3000);
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifycanceladmissionbuttonclickable.png")
    })
})