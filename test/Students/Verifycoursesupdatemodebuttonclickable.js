...
describe("Verify courses updatemode button is clickable ",function(){
    this.retries(2)

    it("update mode button is clickable",async()=> {
        ...
        await Studentpage.coursesupdatemodeisclickable();
        await browser.pause(3000);
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifyupdatemodebuttonclickable.png")
    })
})