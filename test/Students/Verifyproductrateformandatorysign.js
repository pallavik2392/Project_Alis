...
describe("Verify  product rate field for mandatory sign ",function(){
    this.retries(2)

    it("product rate field for mandatory sign",async()=> {
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifyproductratefieldformandatorysign.png")
    })
})