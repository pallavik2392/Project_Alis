...
describe("Verify  scholarship successfully can be added for same course only once",function(){
    this.retries(2)

    it("add scholarship for same course only once",async()=> {
        ...
        await expect(message).toHaveTextContaining("This student has already given an award for this type and course");
        await browser.pause(3000);
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifycanaddscholarshipforsamecourseanlyonce.png")
    })
})