...
describe("Verify  user is able to update mode ",function(){
    this.retries(2)
    ...
    it("update mode",async()=> {
        ...
        await browser.pause(3000);
        await Coursespage.disablePayablewhenable();
        await browser.pause(3000);
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifyupdatemode.png")
    })
})