...
describe("Verify  invoices view transaction  button is working properly ",function(){
    this.retries(2)

    it("invoices view transaction button is working properly",async()=> {
        ...
        await browser.pause(3000);
        await Studentpage.invoicesviewtransactionisclickable();
        await browser.pause(3000);
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifyinvoiceviewtransactionbuttonclickable.png")
    })
})