...
describe("Verify courses add to wallet button is clickable ",function(){
    this.retries(2)

    it("add to wallet button is clickable",async()=> {
        ...
        await Studentpage.coursesaddtowalletisclickable();
        await browser.pause(3000);
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifyaddtowalletbuttonclickable.png")
    })
})