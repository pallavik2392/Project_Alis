...
describe("Verify courses filter for history tab of support",function(){
    this.retries(3)

    it("courses filter of history tab",async ()=> {
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifycoursesfilterofhistorytabofsupport.png")
    })
})