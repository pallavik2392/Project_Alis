...
describe("Verify locations filter for history tab of support",function(){
    this.retries(3)

    it("locations filter of history tab",async ()=> {
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifylocationsfilterofhistorytabofsupport.png")
    })
})