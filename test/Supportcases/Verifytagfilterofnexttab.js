...
describe("Verify tag filter for next tab of support",function(){
    this.retries(3)

    it("tag filter of next tab",async ()=> {
        ...
        const message=await $("//body/div[@id='root']/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[3]/div[1]/div[1]/div[1]/div[1]/div[8]/div[1]/div[2]/child::p");
    ...
    after(async()=>{
        await browser.saveScreenshot("./ScreenshotsforAlis/Verifytagfilterofnexttabofsupport.png")
    })
})